...
# 4b. Debate Vectors with BERT
# Input: debate_classification_bert.pkl
# Output: debate vectors (d_vec_bert.pkl) for debates with clear topic and stance
...
df = pd.read_pickle('../data/processed/pkl/debate_classification_bert.pkl')
...
# --- Save processed data ---
df_red.to_pickle('../data/processed/pkl/d_vec_bert.pkl')
df_red.to_csv('../data/processed/csv/d_vec_bert.csv', index=False)
